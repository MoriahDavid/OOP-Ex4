...
public class BaseDirectedWeightedGraphAlgo implements api.DirectedWeightedGraphAlgorithms{
    ...
    public static void main(String[] args){
        ...
        System.out.println(a.shortestPath(0,10));
        System.out.println(a.shortestPathDist(0,10));
...
//        System.out.println("Total Nodes in graph: " + l.size());
        l.add(a.getGraph().getNode(1));
        l.add(a.getGraph().getNode(5));
        l.add(a.getGraph().getNode(10));
...
//
        ...
        BaseDirectedWeightedGraphAlgo a1 = new BaseDirectedWeightedGraphAlgo();
        for(int i=0; i<5; i++){
            a1.getGraph().addNode(new BaseNodeData(i,0,"",0, new BaseGeoLocation(0,0)));
        }

        a1.getGraph().connect(0, 1, 1);
        a1.getGraph().connect(0, 4, 5);
        a1.getGraph().connect(1, 0, 1.1);
        a1.getGraph().connect(1, 2, 1.3);
        a1.getGraph().connect(1, 3, 1.9);
        a1.getGraph().connect(2, 3, 1.1);
        a1.getGraph().connect(3, 4, 2.1);
        a1.getGraph().connect(4, 2, .5);

        System.out.println(a1.isConnected());
    }
}
